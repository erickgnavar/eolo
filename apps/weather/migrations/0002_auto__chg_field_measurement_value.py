...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'weather_measurement', 'value', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=6, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'Measurement.value'
        db.alter_column(u'weather_measurement', 'value', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=4, decimal_places=2))
